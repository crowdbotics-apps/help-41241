"""
Django settings for help_41241 project.
...
WSGI_APPLICATION = 'help_41241.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "help_41241 API",
    "DESCRIPTION": "API documentation for help_41241 App",
    "VERSION": "v1",
}
